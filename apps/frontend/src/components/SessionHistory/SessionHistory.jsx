  ...
  return (
    <Box sx={{ width: '100%', maxWidth: 1180, mx: 'auto', p: { xs: 2, md: 4 } }}>
      <Stack direction={{ xs: 'column', sm: 'row' }} justifyContent="space-between" spacing={2} sx={{ mb: 3 }}>
        ...
        <Button variant="contained" startIcon={<AddCircleOutlineIcon />} onClick={() => navigate('/home')} sx={{ backgroundColor: '#1f6b45' }}>
          ...
          <CardContent sx={{ p: 3 }}>
            ...
            {detailLoading ? (
              ...
              <Box sx={{ py: 5, textAlign: 'center' }}>
                ...
                <Button sx={{ mt: 1 }} onClick={() => navigate('/home')}>Ajouter une séance</Button>
              </Box>
            ) : (
              <Stack spacing={1.5}>

...
function HighlightedDay({ highlightedDays = [], day, ...props }) {
    const isHighlighted = !props.outsideCurrentMonth && highlightedDays.some((value) => {
        const highlightedDate = new Date(value)
        return highlightedDate.getDate() === day.date()
    })

    return <PickerDay {...props} day={day} sx={isHighlighted ? { backgroundColor: 'rgba(255, 173, 173, 0.65)' } : undefined} />
}
                    ...
                    <Grid container spacing={1}>
                        <Grid size={{ xs: 12, sm: 6 }}>
                            ...
                            <LocalizationProvider dateAdapter={AdapterDayjs}>
                                ...
                                slotProps={{ day: { highlightedDays: days } }}
                            />

    ...
    <Box sx={{ width: '100%', maxWidth: 1240, mx: 'auto', p: { xs: 2, md: 4 } }}>
      <Stack direction={{ xs: 'column', md: 'row' }} justifyContent="space-between" spacing={2} sx={{ mb: 3 }}>
        ...
        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5}>
          <Button variant="contained" startIcon={<InsightsOutlinedIcon />} onClick={() => navigate(`/analyse-mur?version=${selectedVersion}`)} disabled={!selectedVersion} sx={{ backgroundColor: '#1f6b45', '&:hover': { backgroundColor: '#185538' } }}>Analyse du mur</Button>
